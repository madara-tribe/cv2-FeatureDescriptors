...
from normaly_cv2detector import sift, akaze, surf
...
def main(path1, path2, out_name):
    ...
    ##### detect homography #####
    sift_homography, sift_matches = sift.sift_homography(img1, img2)
    surf_homography, surf_matches = surf.surf_homography(img1, img2)
    akaze_homography, akaze_matches = akaze.akaze_homography(img1, img2)
    ...
    print('sift homograhy', sift_homography)
    print('surf homograhy', surf_homography)
    print('akaze homograhy', akaze_homography)
    #except TypeError:
    #    print('pass2')
